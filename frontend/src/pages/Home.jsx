...
import YourAssistantComponent from "../context/Gemini";
                        ...
                        <div className="relative w-full h-full md:w-120 md:h-120 flex justify-center items-center ">
                            <div className="absolute floating-avatar inset-0 z-0 flex justify-center items-center mb-4">
                                <img
                                    src={bgImg}
                                    alt="Background Glow"
                                    className="w-[370px] h-[370px] md:w-[460px] md:h-[460px] object-cover opacity-100 blur-sm rounded-fullpointer-events-none"
                                />
                            </div>
                            ...
                            {!unlocked ? (
                                ...
                                <>
                                    ...
                                    <div className="relative mt-4 h-24 md:w-[500px] overflow-y-auto no-scrollbar text-center px-2">
                                        {showingAiResponse && (
                                            <p className="text-gray-700 italic text-lg w-full border-l-4 border-blue-400 pl-4">
